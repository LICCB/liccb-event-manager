...
class EventStrategies extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
	    $builder
			...
			->add('over18W', NumberType::class, array(
				'label' => false,
				'label_attr' => array('min' => '0', 'max' => '10', 'required'),
			))
			...
			->add('swimExperienceW', NumberType::class, array(
				'label' => false,
				'label_attr' => array('min' => '0', 'max' => '10', 'required'),
			))
			...
			->add('boatExperienceW', NumberType::class, array(
				'label' => false,
				'label_attr' => array('min' => '0', 'max' => '10', 'required'),		
			))
			...
			->add('CprW', NumberType::class, array(
				'label' => false,
				'label_attr' => array('min' => '0', 'max' => '10', 'required'),
			...
			->add('participantTypeW', NumberType::class, array(
				'label' => false,
			))
